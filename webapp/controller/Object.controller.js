		...
		return BaseController.extend("zjblessons.Worklist.controller.Object", {
			...
			_onBindingChange : function () {
				...
				onDeleteObject :function(){
					...
					var sObjectName = oObject.DocumentNumber;
					MessageBox.confirm(`You approve deletion of ${sObjectName} ?`, {
				...
				MessageBox.confirm('Approve delete order "{DocumentDate}"?');
				},
